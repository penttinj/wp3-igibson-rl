    ...
    def step(self, action):
        ...
        ######## print("Debug: igibson_env.py: step(): state['task_obs']=", state["task_obs"])
        info = {}
    ...
    def test_valid_position(self, obj, pos, orn=None):
        ...
        body_id = obj.robot_ids[0] if is_robot else obj.body_id
        has_collision = self.check_collision(body_id)  # Should be named has_no_collision
    ...
    def land(self, obj, pos, orn):
        ...
        if not land_success:
            print(
                "WARNING: Failed to land"
            )  # Shouldn't the program throw or exit if it can't land?
