...
class StaticGoalTask(BaseTask):
    ...
    def __init__(self, env):
        print("StaticGoalTask: init")
        super(StaticGoalTask, self).__init__(env)
    ...
    def get_termination(self, env, collision_links=[], action=None, info={}):
        ...
        """
        done, info = super(StaticGoalTask, self).get_termination(
